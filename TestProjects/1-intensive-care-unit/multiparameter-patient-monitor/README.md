...
| device code | `src/main/java/com/harpia/patientmonitor/DeviceApp.java`, `.../HumanMock.java` |
...
Docker/run.sh bash -c '
  HARPIA_GEN_LANG=java \
    ...
    HARPIA_OUTPUT_DIR=/tmp/multiparameter-patient-monitor_gen python3 main.py &&
