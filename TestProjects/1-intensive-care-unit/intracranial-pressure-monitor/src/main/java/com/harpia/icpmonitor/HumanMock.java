...
/**
 * Simulates normal human and operator behaviour for the Intracranial Pressure (ICP) Monitor,
...
public final class HumanMock {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Intracranial Pressure (ICP) Monitor human-mock: done");
    }
}
