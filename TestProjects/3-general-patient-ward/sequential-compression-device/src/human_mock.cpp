...
// Sequential Compression Device (SCD), emitting a physiologically plausible stream of its
...
int main() {
    ...
    std::cout << "Sequential Compression Device (SCD) human-mock: done" << std::endl;
    return 0;
}
