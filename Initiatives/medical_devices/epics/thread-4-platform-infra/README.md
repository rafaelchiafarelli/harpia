...
- [track-n-static-fuzz-ci.md](histories/static-fuzz-ci/track-n-static-fuzz-ci.md) — static/fuzz
  analysis CI.
- [track-l-versioning.md](histories/versioning/track-l-versioning.md) — versioning/git
...
- **Track M and Track N** — no dependencies on each other, on Track L, or
  ...
  breakdown moved to `Initiatives/multi-language-targets/` — it isn't one of
...
from `Initiatives/multi-language-targets/` (a different plan folder now, but
...
- **Ground Rule 6 (`../foundation.md`, added 2026-08-23):** any session
  ...
  sessions live in `Initiatives/multi-language-targets/` now (see that plan's
