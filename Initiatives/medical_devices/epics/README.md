...
| [dds-transport](dds-transport/) | DDS transport adapter (ASTM F2761 / OpenICE-class bedside bus) | planning done (tasks 1, 2a `dds-vendor-and-spike`, 2b, 3, 4, 5 scoped; DDS vendor is 2a's spike-then-commit, starting candidate Eclipse Cyclone DDS; `deadline[ms]` QoS carved out pending domain expert) |
