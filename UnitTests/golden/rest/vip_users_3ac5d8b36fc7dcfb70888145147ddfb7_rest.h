...
#ifndef HARPIA_REST_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_REST_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
// vip_users declares a "pagination[size]" field (its size becomes the default
...
// Role gate for vip_users (transport-authn epic, task 4). Resolves the verified
...
inline bool authz_vip_users(const crow::request& req, crow::response& res,
    ...
    switch (::harpia::rbac::decide(req.client_cert_cn, op, "vip_users")) {
...
inline void register_vip_users(crow::SimpleApp& app, ::soci::session& db,
...
#endif  // HARPIA_REST_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
