...
#ifndef HARPIA_REST_JOURNEY_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_REST_JOURNEY_3ac5d8b36fc7dcfb70888145147ddfb7
...
//               X-User: journey and X-Pswd: 3ac5d8b36fc7dcfb70888145147ddfb7, or it is rejected with 401
...
// Role gate for journey (transport-authn epic, task 4). Resolves the verified
...
inline bool authz_journey(const crow::request& req, crow::response& res,
                         ::harpia::rbac::Operation op) {
    switch (::harpia::rbac::decide(req.client_cert_cn, op, "journey")) {
...
#endif  // HARPIA_REST_JOURNEY_3ac5d8b36fc7dcfb70888145147ddfb7
