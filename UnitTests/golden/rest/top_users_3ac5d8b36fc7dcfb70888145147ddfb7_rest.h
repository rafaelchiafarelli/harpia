...
// the request must carry X-User: top_users and X-Pswd: 3ac5d8b36fc7dcfb70888145147ddfb7, or it is rejected
...
inline bool authorized_top_users(const crow::request& req) {
