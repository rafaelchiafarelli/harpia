...
#ifndef HARPIA_REST_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_REST_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
//               X-User: top_users and X-Pswd: 3ac5d8b36fc7dcfb70888145147ddfb7, or it is rejected with 401
...
// Role gate for top_users (transport-authn epic, task 4). Resolves the verified
...
inline bool authz_top_users(const crow::request& req, crow::response& res,
                         ::harpia::rbac::Operation op) {
    switch (::harpia::rbac::decide(req.client_cert_cn, op, "top_users")) {
...
inline bool wants_xml_top_users(const crow::request& req) {
    return req.get_header_value("Accept").find("xml") != std::string::npos;
}
inline bool body_xml_top_users(const crow::request& req) {
    return req.get_header_value("Content-Type").find("xml") != std::string::npos;
}
inline bool parse_top_users(const crow::request& req, ::top_users* msg) {
    return body_xml_top_users(req) ? ::harpia::xml::from_xml(req.body, msg)
                                : ::harpia::json::from_json(req.body, msg);
}
inline void serialize_top_users(const crow::request& req,
                             const ::top_users& msg, crow::response& res) {
...
inline void register_top_users(crow::SimpleApp& app, ::soci::session& db,
    ...
    app.route_dynamic(col).methods(crow::HTTPMethod::GET)(
        [dbp](const crow::request& req, crow::response& res) {
            if (!authz_top_users(req, res, ::harpia::rbac::Operation::list)) { res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::GET)(
        [dbp](const crow::request& req, crow::response& res, int64_t id) {
            if (!authz_top_users(req, res, ::harpia::rbac::Operation::read)) { res.end(); return; }
            ::harpia::db::top_users_dao dao(*dbp);
            ::top_users msg;
    ...
    app.route_dynamic(col).methods(crow::HTTPMethod::POST)(
        [dbp](const crow::request& req, crow::response& res) {
            if (!authz_top_users(req, res, ::harpia::rbac::Operation::create)) { res.end(); return; }
            ::harpia::db::top_users_dao dao(*dbp);
            ::top_users msg;
            if (!parse_top_users(req, &msg)) { res.code = 400; res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::PUT)(
        [dbp](const crow::request& req, crow::response& res, int64_t) {
            if (!authz_top_users(req, res, ::harpia::rbac::Operation::update)) { res.end(); return; }
            ::harpia::db::top_users_dao dao(*dbp);
            ::top_users msg;
            if (!parse_top_users(req, &msg)) { res.code = 400; res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::DELETE)(
        [dbp](const crow::request& req, crow::response& res, int64_t id) {
            if (!authz_top_users(req, res, ::harpia::rbac::Operation::remove)) { res.end(); return; }
            ::harpia::db::top_users_dao dao(*dbp);
...
#endif  // HARPIA_REST_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
