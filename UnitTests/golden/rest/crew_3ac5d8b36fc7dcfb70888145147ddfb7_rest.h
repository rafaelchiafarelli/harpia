...
#ifndef HARPIA_REST_CREW_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_REST_CREW_3ac5d8b36fc7dcfb70888145147ddfb7
...
inline void register_crew(crow::SimpleApp& app, ::soci::session& db,
    ...
    app.route_dynamic(col).methods(crow::HTTPMethod::GET)(
        [dbp](const crow::request& req, crow::response& res) {
            if (!authz_crew(req, res, ::harpia::rbac::Operation::list)) { res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::GET)(
        [dbp](const crow::request& req, crow::response& res, int64_t id) {
            if (!authz_crew(req, res, ::harpia::rbac::Operation::read)) { res.end(); return; }
            ::harpia::db::crew_dao dao(*dbp);
            ::crew msg;
    ...
    app.route_dynamic(col).methods(crow::HTTPMethod::POST)(
        [dbp](const crow::request& req, crow::response& res) {
            if (!authz_crew(req, res, ::harpia::rbac::Operation::create)) { res.end(); return; }
            ::harpia::db::crew_dao dao(*dbp);
            ::crew msg;
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::PUT)(
        [dbp](const crow::request& req, crow::response& res, int64_t) {
            if (!authz_crew(req, res, ::harpia::rbac::Operation::update)) { res.end(); return; }
            ::harpia::db::crew_dao dao(*dbp);
            ::crew msg;
            if (!parse_crew(req, &msg)) { res.code = 400; res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::DELETE)(
        [dbp](const crow::request& req, crow::response& res, int64_t id) {
            if (!authz_crew(req, res, ::harpia::rbac::Operation::remove)) { res.end(); return; }
            ::harpia::db::crew_dao dao(*dbp);
...
#endif  // HARPIA_REST_CREW_3ac5d8b36fc7dcfb70888145147ddfb7
