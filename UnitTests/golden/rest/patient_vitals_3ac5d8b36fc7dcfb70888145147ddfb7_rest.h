...
//               X-User: patient_vitals and X-Pswd: 3ac5d8b36fc7dcfb70888145147ddfb7, or it is rejected with 401
...
// Role gate for patient_vitals (transport-authn epic, task 4). Resolves the verified
...
inline bool authz_patient_vitals(const crow::request& req, crow::response& res,
                         ::harpia::rbac::Operation op) {
    switch (::harpia::rbac::decide(req.client_cert_cn, op, "patient_vitals")) {
...
inline void register_patient_vitals(crow::SimpleApp& app, ::soci::session& db,
    ...
    app.route_dynamic(col).methods(crow::HTTPMethod::GET)(
        [dbp](const crow::request& req, crow::response& res) {
            if (!authz_patient_vitals(req, res, ::harpia::rbac::Operation::list)) { res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::GET)(
        [dbp](const crow::request& req, crow::response& res, int64_t id) {
            if (!authz_patient_vitals(req, res, ::harpia::rbac::Operation::read)) { res.end(); return; }
            ::harpia::db::patient_vitals_dao dao(*dbp);
            ::patient_vitals msg;
    ...
    app.route_dynamic(col).methods(crow::HTTPMethod::POST)(
        [dbp](const crow::request& req, crow::response& res) {
            if (!authz_patient_vitals(req, res, ::harpia::rbac::Operation::create)) { res.end(); return; }
            ::harpia::db::patient_vitals_dao dao(*dbp);
            ::patient_vitals msg;
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::PUT)(
        [dbp](const crow::request& req, crow::response& res, int64_t) {
            if (!authz_patient_vitals(req, res, ::harpia::rbac::Operation::update)) { res.end(); return; }
            ::harpia::db::patient_vitals_dao dao(*dbp);
            ::patient_vitals msg;
            if (!parse_patient_vitals(req, &msg)) { res.code = 400; res.end(); return; }
    ...
    app.route_dynamic(item).methods(crow::HTTPMethod::DELETE)(
        [dbp](const crow::request& req, crow::response& res, int64_t id) {
            if (!authz_patient_vitals(req, res, ::harpia::rbac::Operation::remove)) { res.end(); return; }
            ::harpia::db::patient_vitals_dao dao(*dbp);
