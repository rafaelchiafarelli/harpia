...
#ifndef HARPIA_MIGRATE_RECEPTION_DESK_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_RECEPTION_DESK_3ac5d8b36fc7dcfb70888145147ddfb7
...
// Schema migration for reception_desk (spec 8 / 7.2 "validation/transformative functions
...
// idempotent (e.g. guard with a WHERE clause) since migrate_reception_desk may run
// on every startup.
//
...
inline bool migrate_reception_desk(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> _child_have;
        {
            ...
            ::soci::statement _cts = (db.prepare << "SELECT \"name\" FROM sqlite_master WHERE type = 'table' AND substr(\"name\", 1, 22) = 'reception_desk_table__';",
        ...
        std::set<std::string> have;
        {
            ...
            ::soci::statement _cs = (db.prepare << "SELECT \"name\" FROM pragma_table_info('reception_desk_table');",
                                     ::soci::into(_cn, _ci));
            _cs.execute();
        ...
        // (a second migrate_reception_desk call, or a table that never had it).

        // additive migration: add any column missing from an older table version
        if (!have.count("visitor_name")) {
            db << "ALTER TABLE \"reception_desk_table\" ADD COLUMN \"visitor_name\" TEXT;";
        }
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"reception_desk_table\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"reception_desk_table\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ORIGINATOR")) {
            db << "ALTER TABLE \"reception_desk_table\" ADD COLUMN \"ORIGINATOR\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "visitor_name", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR" };
            for (auto _hit = have.begin(); _hit != have.end(); ) {
                if (!_current.count(*_hit)) {
                    const std::string& _dc = *_hit;
                    db << "ALTER TABLE \"reception_desk_table\" DROP COLUMN \"" + _dc + "\";";
        ...
        std::map<std::string, std::string> have_types;
        {
            ...
            ::soci::statement _ts = (db.prepare << "SELECT \"name\", \"type\" FROM pragma_table_info('reception_desk_table');",
        ...
        bool _needs_retype = false;
            ...
            if (have_types.count("visitor_name") && have_types["visitor_name"] != "TEXT") _needs_retype = true;
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"reception_desk_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"visitor_name\" TEXT, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR\" TEXT);";
            db << "INSERT INTO \"reception_desk_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"visitor_name\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"visitor_name\" AS TEXT), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR\" AS TEXT) FROM \"reception_desk_table\";";
            db << "DROP TABLE \"reception_desk_table\";";
            db << "ALTER TABLE \"reception_desk_table__retype_tmp\" RENAME TO \"reception_desk_table\";";
        }
        }
        ...
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('reception_desk_table', '3ac5d8b36fc7dcfb70888145147ddfb7');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_reception_desk() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_RECEPTION_DESK_3ac5d8b36fc7dcfb70888145147ddfb7
