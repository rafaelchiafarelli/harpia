...
#ifndef HARPIA_MIGRATE_JOURNEY_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_JOURNEY_3ac5d8b36fc7dcfb70888145147ddfb7
...
inline bool migrate_journey(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> _child_have;
        {
            ...
            ::soci::statement _cts = (db.prepare << "SELECT \"name\" FROM sqlite_master WHERE type = 'table' AND substr(\"name\", 1, 15) = 'journey_table__';",
        ...
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"journey_table\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"journey_table\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "path_start_city", "path_start_elevation", "path_label", "vessel", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR" };
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"journey_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"path_start_city\" TEXT, \"path_start_elevation\" INTEGER, \"path_label\" TEXT, \"vessel\" TEXT, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR\" TEXT);";
            db << "INSERT INTO \"journey_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"path_start_city\", \"path_start_elevation\", \"path_label\", \"vessel\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"path_start_city\" AS TEXT), CAST(\"path_start_elevation\" AS INTEGER), CAST(\"path_label\" AS TEXT), CAST(\"vessel\" AS TEXT), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR\" AS TEXT) FROM \"journey_table\";";
        ...
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('journey_table', '3ac5d8b36fc7dcfb70888145147ddfb7');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_journey() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_JOURNEY_3ac5d8b36fc7dcfb70888145147ddfb7
