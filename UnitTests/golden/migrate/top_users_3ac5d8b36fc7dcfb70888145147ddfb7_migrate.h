...
#ifndef HARPIA_MIGRATE_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
// idempotent (e.g. guard with a WHERE clause) since migrate_top_users may run
// on every startup.
//
...
inline bool migrate_top_users(::soci::session& db,
    ...
    try {
        ...
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"user_table\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"user_table\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"user_table\" ADD COLUMN \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "sponsor", "name", "myUsers", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7" };
        ...
        std::map<std::string, std::string> have_types;
        {
            ...
            ::soci::statement _ts = (db.prepare << "SELECT \"name\", \"type\" FROM pragma_table_info('user_table');",
        ...
        bool _needs_retype = false;
            ...
            if (have_types.count("sponsor") && have_types["sponsor"] != "TEXT") _needs_retype = true;
            if (have_types.count("name") && have_types["name"] != "TEXT") _needs_retype = true;
            if (have_types.count("myUsers") && have_types["myUsers"] != "INTEGER") _needs_retype = true;
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"user_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"sponsor\" TEXT, \"name\" TEXT NOT NULL, \"myUsers\" INTEGER, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT);";
            db << "INSERT INTO \"user_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"sponsor\", \"name\", \"myUsers\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"sponsor\" AS TEXT), CAST(\"name\" AS TEXT), CAST(\"myUsers\" AS INTEGER), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT) FROM \"user_table\";";
            db << "DROP TABLE \"user_table\";";
...
inline const char* version_top_users() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
