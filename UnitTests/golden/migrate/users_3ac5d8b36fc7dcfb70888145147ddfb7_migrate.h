...
#ifndef HARPIA_MIGRATE_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
// idempotent (e.g. guard with a WHERE clause) since migrate_users may run
// on every startup.
//
...
inline bool migrate_users(::soci::session& db,
    ...
    try {
        ...
        // (a second migrate_users call, or a table that never had it).
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "address", "name", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7" };
        ...
        bool _needs_retype = false;
            ...
            if (have_types.count("address") && have_types["address"] != "TEXT") _needs_retype = true;
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"user_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"address\" TEXT, \"name\" TEXT, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT);";
            db << "INSERT INTO \"user_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"address\", \"name\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"address\" AS TEXT), CAST(\"name\" AS TEXT), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT) FROM \"user_table\";";
...
inline const char* version_users() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
