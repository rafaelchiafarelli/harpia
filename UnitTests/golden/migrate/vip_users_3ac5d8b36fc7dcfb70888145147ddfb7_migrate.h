...
#ifndef HARPIA_MIGRATE_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
// idempotent (e.g. guard with a WHERE clause) since migrate_vip_users may run
// on every startup.
//
...
inline bool migrate_vip_users(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> _child_have;
        {
            ...
            ::soci::statement _cts = (db.prepare << "SELECT \"name\" FROM sqlite_master WHERE type = 'table' AND substr(\"name\", 1, 17) = 'table_vip_users__';",
        ...
        std::set<std::string> have;
        {
            ...
            ::soci::statement _cs = (db.prepare << "SELECT \"name\" FROM pragma_table_info('table_vip_users');",
                                     ::soci::into(_cn, _ci));
            _cs.execute();
        ...
        // (a second migrate_vip_users call, or a table that never had it).

        // additive migration: add any column missing from an older table version
        if (!have.count("name")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"name\" TEXT;";
        }
        if (!have.count("family")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"family\" TEXT;";
        }
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "name", "family", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7" };
            for (auto _hit = have.begin(); _hit != have.end(); ) {
                if (!_current.count(*_hit)) {
                    const std::string& _dc = *_hit;
                    db << "ALTER TABLE \"table_vip_users\" DROP COLUMN \"" + _dc + "\";";
        ...
        std::map<std::string, std::string> have_types;
        {
            ...
            ::soci::statement _ts = (db.prepare << "SELECT \"name\", \"type\" FROM pragma_table_info('table_vip_users');",
        ...
        bool _needs_retype = false;
            ...
            if (have_types.count("family") && have_types["family"] != "TEXT") _needs_retype = true;
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"table_vip_users__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"name\" TEXT, \"family\" TEXT, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT);";
            db << "INSERT INTO \"table_vip_users__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"name\", \"family\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"name\" AS TEXT), CAST(\"family\" AS TEXT), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT) FROM \"table_vip_users\";";
            db << "DROP TABLE \"table_vip_users\";";
        ...
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('table_vip_users', '3ac5d8b36fc7dcfb70888145147ddfb7');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_vip_users() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
