...
#ifndef HARPIA_MIGRATE_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
...
// Schema migration for vault (spec 8 / 7.2 "validation/transformative functions
...
// idempotent (e.g. guard with a WHERE clause) since migrate_vault may run
// on every startup.
//
...
inline bool migrate_vault(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> _child_have;
        {
            ...
            ::soci::statement _cts = (db.prepare << "SELECT \"name\" FROM sqlite_master WHERE type = 'table' AND substr(\"name\", 1, 13) = 'vault_table__';",
        ...
        std::set<std::string> have;
        {
            ...
            ::soci::statement _cs = (db.prepare << "SELECT \"name\" FROM pragma_table_info('vault_table');",
                                     ::soci::into(_cn, _ci));
            _cs.execute();
        ...
        // (a second migrate_vault call, or a table that never had it).

        // additive migration: add any column missing from an older table version
        if (!have.count("secret_code")) {
            db << "ALTER TABLE \"vault_table\" ADD COLUMN \"secret_code\" TEXT;";
        }
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"vault_table\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"vault_table\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ORIGINATOR")) {
            db << "ALTER TABLE \"vault_table\" ADD COLUMN \"ORIGINATOR\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "secret_code", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR" };
            for (auto _hit = have.begin(); _hit != have.end(); ) {
                if (!_current.count(*_hit)) {
                    const std::string& _dc = *_hit;
                    db << "ALTER TABLE \"vault_table\" DROP COLUMN \"" + _dc + "\";";
        ...
        std::map<std::string, std::string> have_types;
        {
            ...
            ::soci::statement _ts = (db.prepare << "SELECT \"name\", \"type\" FROM pragma_table_info('vault_table');",
        ...
        bool _needs_retype = false;
            ...
            if (have_types.count("secret_code") && have_types["secret_code"] != "TEXT") _needs_retype = true;
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"vault_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"secret_code\" TEXT, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR\" TEXT);";
            db << "INSERT INTO \"vault_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"secret_code\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"secret_code\" AS TEXT), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR\" AS TEXT) FROM \"vault_table\";";
            db << "DROP TABLE \"vault_table\";";
            db << "ALTER TABLE \"vault_table__retype_tmp\" RENAME TO \"vault_table\";";
        }
        }
        ...
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('vault_table', '3ac5d8b36fc7dcfb70888145147ddfb7');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_vault() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
