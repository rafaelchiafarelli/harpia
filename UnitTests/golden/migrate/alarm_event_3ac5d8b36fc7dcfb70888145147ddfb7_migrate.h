...
#ifndef HARPIA_MIGRATE_ALARM_EVENT_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_ALARM_EVENT_3ac5d8b36fc7dcfb70888145147ddfb7
...
// Schema migration for alarm_event (spec 8 / 7.2 "validation/transformative functions
...
// idempotent (e.g. guard with a WHERE clause) since migrate_alarm_event may run
// on every startup.
//
...
inline bool migrate_alarm_event(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> _child_have;
        {
            ...
            ::soci::statement _cts = (db.prepare << "SELECT \"name\" FROM sqlite_master WHERE type = 'table' AND substr(\"name\", 1, 19) = 'alarm_event_table__';",
        ...
        std::set<std::string> have;
        {
            ...
            ::soci::statement _cs = (db.prepare << "SELECT \"name\" FROM pragma_table_info('alarm_event_table');",
                                     ::soci::into(_cn, _ci));
            _cs.execute();
        ...
        // (a second migrate_alarm_event call, or a table that never had it).

        // additive migration: add any column missing from an older table version
        if (!have.count("patient_id")) {
            db << "ALTER TABLE \"alarm_event_table\" ADD COLUMN \"patient_id\" TEXT;";
        }
        if (!have.count("alarm_type")) {
            db << "ALTER TABLE \"alarm_event_table\" ADD COLUMN \"alarm_type\" TEXT;";
        }
        if (!have.count("severity")) {
            db << "ALTER TABLE \"alarm_event_table\" ADD COLUMN \"severity\" INTEGER;";
        }
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"alarm_event_table\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"alarm_event_table\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"alarm_event_table\" ADD COLUMN \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "patient_id", "alarm_type", "severity", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7" };
            for (auto _hit = have.begin(); _hit != have.end(); ) {
                if (!_current.count(*_hit)) {
                    const std::string& _dc = *_hit;
                    db << "ALTER TABLE \"alarm_event_table\" DROP COLUMN \"" + _dc + "\";";
        ...
        std::map<std::string, std::string> have_types;
        {
            ...
            ::soci::statement _ts = (db.prepare << "SELECT \"name\", \"type\" FROM pragma_table_info('alarm_event_table');",
        ...
        bool _needs_retype = false;
            ...
            if (have_types.count("alarm_type") && have_types["alarm_type"] != "TEXT") _needs_retype = true;
            if (have_types.count("severity") && have_types["severity"] != "INTEGER") _needs_retype = true;
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"alarm_event_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"patient_id\" TEXT, \"alarm_type\" TEXT, \"severity\" INTEGER, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT);";
            db << "INSERT INTO \"alarm_event_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"patient_id\", \"alarm_type\", \"severity\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"patient_id\" AS TEXT), CAST(\"alarm_type\" AS TEXT), CAST(\"severity\" AS INTEGER), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT) FROM \"alarm_event_table\";";
            db << "DROP TABLE \"alarm_event_table\";";
            db << "ALTER TABLE \"alarm_event_table__retype_tmp\" RENAME TO \"alarm_event_table\";";
        }
        }
        ...
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('alarm_event_table', '3ac5d8b36fc7dcfb70888145147ddfb7');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_alarm_event() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_ALARM_EVENT_3ac5d8b36fc7dcfb70888145147ddfb7
