...
#ifndef HARPIA_MIGRATE_CREW_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_MIGRATE_CREW_3ac5d8b36fc7dcfb70888145147ddfb7
...
// Schema migration for crew (spec 8 / 7.2 "validation/transformative functions
...
// idempotent (e.g. guard with a WHERE clause) since migrate_crew may run
// on every startup.
//
...
inline bool migrate_crew(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> _child_have;
        {
            ...
            ::soci::statement _cts = (db.prepare << "SELECT \"name\" FROM sqlite_master WHERE type = 'table' AND substr(\"name\", 1, 12) = 'crew_table__';",
        ...
        std::set<std::string> have;
        {
            ...
            ::soci::statement _cs = (db.prepare << "SELECT \"name\" FROM pragma_table_info('crew_table');",
                                     ::soci::into(_cn, _ci));
            _cs.execute();
        ...
        // (a second migrate_crew call, or a table that never had it).

        // additive migration: add any column missing from an older table version
        if (!have.count("name")) {
            db << "ALTER TABLE \"crew_table\" ADD COLUMN \"name\" TEXT;";
        }
        if (!have.count("STATUS_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"crew_table\" ADD COLUMN \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ERROR_3ac5d8b36fc7dcfb70888145147ddfb7")) {
            db << "ALTER TABLE \"crew_table\" ADD COLUMN \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT;";
        }
        if (!have.count("ORIGINATOR")) {
            db << "ALTER TABLE \"crew_table\" ADD COLUMN \"ORIGINATOR\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_3ac5d8b36fc7dcfb70888145147ddfb7", "name", "STATUS_3ac5d8b36fc7dcfb70888145147ddfb7", "ERROR_3ac5d8b36fc7dcfb70888145147ddfb7", "ORIGINATOR" };
            for (auto _hit = have.begin(); _hit != have.end(); ) {
                if (!_current.count(*_hit)) {
                    const std::string& _dc = *_hit;
                    db << "ALTER TABLE \"crew_table\" DROP COLUMN \"" + _dc + "\";";
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"crew_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" INTEGER PRIMARY KEY, \"name\" TEXT, \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" TEXT, \"ORIGINATOR\" TEXT);";
            db << "INSERT INTO \"crew_table__retype_tmp\" (\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\", \"name\", \"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\", \"ORIGINATOR\") SELECT CAST(\"ID_3ac5d8b36fc7dcfb70888145147ddfb7\" AS INTEGER), CAST(\"name\" AS TEXT), CAST(\"STATUS_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ERROR_3ac5d8b36fc7dcfb70888145147ddfb7\" AS TEXT), CAST(\"ORIGINATOR\" AS TEXT) FROM \"crew_table\";";
        ...
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('crew_table', '3ac5d8b36fc7dcfb70888145147ddfb7');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_crew() { return "3ac5d8b36fc7dcfb70888145147ddfb7"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_CREW_3ac5d8b36fc7dcfb70888145147ddfb7
