...
#ifndef HARPIA_SOAP_TELEMETRY_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_SOAP_TELEMETRY_3ac5d8b36fc7dcfb70888145147ddfb7
...
inline void register_telemetry_soap(crow::SimpleApp& app, ::soci::session& db,
    ...
    ::soci::session* dbp = &db;
    app.route_dynamic(base + "/telemetry").methods(crow::HTTPMethod::POST)(
        ...
        if (rbac_known) {
            const auto rbac_d =
                ::harpia::rbac::decide(req.client_cert_cn, rbac_op, "telemetry");
        ...
        if (name == "get") {
            ...
            const auto* m = op->FirstChildElement();          // the telemetry element
            ::telemetry msg;
...
#endif  // HARPIA_SOAP_TELEMETRY_3ac5d8b36fc7dcfb70888145147ddfb7
