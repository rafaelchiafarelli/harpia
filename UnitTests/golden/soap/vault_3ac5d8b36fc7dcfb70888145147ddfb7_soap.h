...
#ifndef HARPIA_SOAP_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_SOAP_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
...
#include "xml/vault_3ac5d8b36fc7dcfb70888145147ddfb7_xml.h"   // brings tinyxml2 + the XML runtime
#include "soap/harpia_soap.h"       // harpia::soap:: envelope-parse seam
#include "http/harpia_rbac.h"
#include "http/harpia_session.h"
// Minimal SOAP-over-HTTP access for vault, backed by the CRUDL DAO. Register on
// a crow::SimpleApp with a base path; POST a SOAP envelope to <base>/vault:
...
inline std::string envelope_vault(const std::string& body) {
    return "<?xml version=\"1.0\"?>"
           "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
           "<soap:Body>" + body + "</soap:Body></soap:Envelope>";
}

inline void register_vault_soap(crow::SimpleApp& app, ::soci::session& db,
    ...
    ::soci::session* dbp = &db;
    app.route_dynamic(base + "/vault").methods(crow::HTTPMethod::POST)(
        ...
        if (rbac_known) {
            const auto rbac_d =
                ::harpia::rbac::decide(rbac_cn, rbac_op, "vault");
        ...
        if (name == "get") {
            ...
            const auto* m = op->FirstChildElement();          // the vault element
            ::vault msg;
...
#endif  // HARPIA_SOAP_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
