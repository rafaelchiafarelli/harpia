...
#ifndef HARPIA_GRPC_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_GRPC_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
...
#include <soci/soci.h>
#include "protofiles/vault_3ac5d8b36fc7dcfb70888145147ddfb7_service.grpc.pb.h"
#include "db/vault_3ac5d8b36fc7dcfb70888145147ddfb7_crudl.h"
#include <grpcpp/security/auth_context.h>
#include "grpc/harpia_rbac.h"
#include "grpc/harpia_session.h"
// gRPC service implementation for vault, backed by the CRUDL DAO -- the RPCs of
// the generated vault_Service are wired to create/read/list over SQLite:
//   push(msg)      -> dao.create(msg)             -> errorCode
//   pullByID(id)   -> dao.read(id)                -> vault_Message (NOT_FOUND)
//   streamSrc()    -> dao.list() streamed back    -> stream vault_Message
...
//               x-user: vault and x-pswd: 3ac5d8b36fc7dcfb70888145147ddfb7 metadata, or it is rejected
...
class vault_service final
    : public ::frameworkProtos::vault_Service::Service {
public:
    explicit vault_service(::soci::session& db) : db_(db) {}
    ...
    // Role gate for vault (transport-authn epic, tasks 4 + 5): identity is a
    ...
    ::grpc::Status pullByID(::grpc::ServerContext* context,
                            const ::frameworkProtos::vault_ID* request,
                            ::frameworkProtos::vault_Message* response) override {
    ...
    ::grpc::Status streamSrc(
            ...
            const ::frameworkProtos::vault_Stream* request,
            ::grpc::ServerWriter< ::frameworkProtos::vault_Message>* writer) override {
        ...
        for (const auto& r : rows) {
            ::frameworkProtos::vault_Message m;
            *m.mutable_msg() = r;
            writer->Write(m);
        }
        return ::grpc::Status::OK;
    ...
    ::grpc::Status heartBeat(::grpc::ServerContext* context,
                             const ::frameworkProtos::vault_HeartBeat* request,
                             ::frameworkProtos::vault_HeartBeat* response) override {
...
#endif  // HARPIA_GRPC_VAULT_3ac5d8b36fc7dcfb70888145147ddfb7
