...
//               x-user: telemetry and x-pswd: 3ac5d8b36fc7dcfb70888145147ddfb7 metadata, or it is rejected
...
public:
    ...
    // Role gate for telemetry (transport-authn epic, task 4): resolve peer_cn() to
    ...
    static ::grpc::Status rbac_check(::grpc::ServerContext* ctx,
        ...
        switch (::harpia::rbac::decide(peer_cn(ctx), op, "telemetry")) {
