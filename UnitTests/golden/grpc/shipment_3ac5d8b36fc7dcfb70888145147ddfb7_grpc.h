...
#ifndef HARPIA_GRPC_SHIPMENT_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_GRPC_SHIPMENT_3ac5d8b36fc7dcfb70888145147ddfb7
...
#include <soci/soci.h>
#include "protofiles/shipment_3ac5d8b36fc7dcfb70888145147ddfb7_service.grpc.pb.h"
...
//               x-user: shipment and x-pswd: 3ac5d8b36fc7dcfb70888145147ddfb7 metadata, or it is rejected
...
public:
    ...
    // Role gate for shipment (transport-authn epic, task 4): resolve peer_cn() to
    ...
    static ::grpc::Status rbac_check(::grpc::ServerContext* ctx,
        ...
        switch (::harpia::rbac::decide(peer_cn(ctx), op, "shipment")) {
...
#endif  // HARPIA_GRPC_SHIPMENT_3ac5d8b36fc7dcfb70888145147ddfb7
