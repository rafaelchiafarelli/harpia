...
#ifndef HARPIA_GRPC_DATA_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_GRPC_DATA_3ac5d8b36fc7dcfb70888145147ddfb7
...
#include <soci/soci.h>
#include "protofiles/data_3ac5d8b36fc7dcfb70888145147ddfb7_service.grpc.pb.h"
...
//               x-user: data and x-pswd: 3ac5d8b36fc7dcfb70888145147ddfb7 metadata, or it is rejected
...
public:
    ...
    // Role gate for data (transport-authn epic, task 4): resolve peer_cn() to
    ...
    static ::grpc::Status rbac_check(::grpc::ServerContext* ctx,
        ...
        switch (::harpia::rbac::decide(peer_cn(ctx), op, "data")) {
    ...
    ::grpc::Status streamSrc(
            ...
            const ::frameworkProtos::data_Stream* request,
...
#endif  // HARPIA_GRPC_DATA_3ac5d8b36fc7dcfb70888145147ddfb7
