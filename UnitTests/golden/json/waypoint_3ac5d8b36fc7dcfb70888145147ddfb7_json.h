...
#ifndef HARPIA_JSON_WAYPOINT_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_WAYPOINT_3ac5d8b36fc7dcfb70888145147ddfb7
...
// message -> JSON
inline bool to_json(const ::waypoint& msg, std::string* out) {
...
//
// The trailing defaulted, unused ::waypoint* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::waypoint* = nullptr) {
    ::waypoint probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_WAYPOINT_3ac5d8b36fc7dcfb70888145147ddfb7
