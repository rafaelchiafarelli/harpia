...
#ifndef HARPIA_JSON_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
//
// The trailing defaulted, unused ::users* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::users* = nullptr) {
    ::users probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
