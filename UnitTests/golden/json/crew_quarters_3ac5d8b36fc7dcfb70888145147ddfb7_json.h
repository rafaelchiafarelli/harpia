...
//
// The trailing defaulted, unused ::crew_quarters* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::crew_quarters* = nullptr) {
    ::crew_quarters probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
