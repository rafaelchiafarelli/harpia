...
#ifndef HARPIA_JSON_TRACE_ROW_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_TRACE_ROW_3ac5d8b36fc7dcfb70888145147ddfb7
...
// message -> JSON
inline bool to_json(const ::trace_row& msg, std::string* out) {
...
inline bool from_json(const std::string& in, ::trace_row* msg) {
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
    return ::google::protobuf::util::JsonStringToMessage(in, msg, opts).ok();
}

// is the JSON a valid trace_row message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::trace_row* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::trace_row* = nullptr) {
    ::trace_row probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_TRACE_ROW_3ac5d8b36fc7dcfb70888145147ddfb7
