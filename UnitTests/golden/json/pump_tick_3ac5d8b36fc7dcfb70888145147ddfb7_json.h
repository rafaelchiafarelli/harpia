...
#ifndef HARPIA_JSON_PUMP_TICK_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_PUMP_TICK_3ac5d8b36fc7dcfb70888145147ddfb7
...
// message -> JSON
inline bool to_json(const ::pump_tick& msg, std::string* out) {
...
inline bool from_json(const std::string& in, ::pump_tick* msg) {
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
    return ::google::protobuf::util::JsonStringToMessage(in, msg, opts).ok();
}

// is the JSON a valid pump_tick message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::pump_tick* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::pump_tick* = nullptr) {
    ::pump_tick probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_PUMP_TICK_3ac5d8b36fc7dcfb70888145147ddfb7
