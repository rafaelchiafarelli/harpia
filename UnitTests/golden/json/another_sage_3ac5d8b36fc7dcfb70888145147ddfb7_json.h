...
#ifndef HARPIA_JSON_ANOTHER_SAGE_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_ANOTHER_SAGE_3ac5d8b36fc7dcfb70888145147ddfb7
...
// is the JSON a valid another_sage message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::another_sage* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::another_sage* = nullptr) {
    ::another_sage probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_ANOTHER_SAGE_3ac5d8b36fc7dcfb70888145147ddfb7
