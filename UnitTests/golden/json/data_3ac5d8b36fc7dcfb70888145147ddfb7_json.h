...
#ifndef HARPIA_JSON_DATA_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_DATA_3ac5d8b36fc7dcfb70888145147ddfb7
...
// is the JSON a valid data message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::data* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::data* = nullptr) {
    ::data probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_DATA_3ac5d8b36fc7dcfb70888145147ddfb7
