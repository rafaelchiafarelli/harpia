...
#ifndef HARPIA_JSON_SENSOR_FEED_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_SENSOR_FEED_3ac5d8b36fc7dcfb70888145147ddfb7
...
// message -> JSON
inline bool to_json(const ::sensor_feed& msg, std::string* out) {
...
inline bool from_json(const std::string& in, ::sensor_feed* msg) {
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
    return ::google::protobuf::util::JsonStringToMessage(in, msg, opts).ok();
}

// is the JSON a valid sensor_feed message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::sensor_feed* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::sensor_feed* = nullptr) {
    ::sensor_feed probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_SENSOR_FEED_3ac5d8b36fc7dcfb70888145147ddfb7
