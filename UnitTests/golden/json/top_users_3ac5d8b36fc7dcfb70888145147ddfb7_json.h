...
#ifndef HARPIA_JSON_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
// message -> JSON
inline bool to_json(const ::top_users& msg, std::string* out) {
...
inline bool from_json(const std::string& in, ::top_users* msg) {
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
    return ::google::protobuf::util::JsonStringToMessage(in, msg, opts).ok();
}

// is the JSON a valid top_users message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::top_users* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::top_users* = nullptr) {
    ::top_users probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_TOP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
