...
#ifndef HARPIA_JSON_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
#define HARPIA_JSON_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
...
// is the JSON a valid vip_users message? (same unknown-field tolerance as from_json)
//
// The trailing defaulted, unused ::vip_users* makes this an overload keyed on the
...
inline bool is_valid_json(const std::string& in, const ::vip_users* = nullptr) {
    ::vip_users probe;
    ::google::protobuf::util::JsonParseOptions opts;
    opts.ignore_unknown_fields = true;
...
#endif  // HARPIA_JSON_VIP_USERS_3ac5d8b36fc7dcfb70888145147ddfb7
