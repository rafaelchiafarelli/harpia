...
int access_rights() {
    const std::string good = "<soap:Envelope><soap:Header><credentials><user>users</user><pswd>3ac5d8b36fc7dcfb70888145147ddfb7</pswd></credentials></soap:Header><soap:Body/></soap:Envelope>";
...
int rest_api() {
    ...
    const harpia_test::Headers cred = {{"X-User", "users"}, {"X-Pswd", "3ac5d8b36fc7dcfb70888145147ddfb7"}};
    const harpia_test::Headers credx = {{"X-User", "users"}, {"X-Pswd", "3ac5d8b36fc7dcfb70888145147ddfb7"}, {"Accept", "application/xml"}};
    int code = 0;
    do {
