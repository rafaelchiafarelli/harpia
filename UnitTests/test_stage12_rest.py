...
def built(tmp_path_factory):
    ...
    # transport-authn task 4: this test exercises the flat X-User/X-Pswd gate,
    # which is the variant emitted when the compliance profile does NOT mandate
    # hardened transport. Pin a low-risk profile so RBAC stays compiled out (the
    # RBAC gate has its own end-to-end test, UnitTests/test_rbac.py).
