...
Mirrors UnitTests/test_golden.py's own pattern (same UPDATE/_relpaths/_check
...
To (re)generate after an intentional change:
    ...
    HARPIA_UPDATE_GOLDEN=1 pytest UnitTests/test_golden_java.py
...
def test_java_tree_matches_golden(java_tree):
    ...
    assert produced == expected, (
        ...
        "regenerate with HARPIA_UPDATE_GOLDEN=1 pytest UnitTests/test_golden_java.py "
        "and review the diff")
