...
tests/test_fieldmap.py (drives FieldMap.freeze directly) or
tests/test_fieldmap_frontend.py (drives the real front-end, but only
...
image:
    ...
    docker/run.sh pytest tests/test_message_versioning_wire.py
"""
import hashlib
import os
import re
