...
Complements tests/test_message_versioning_wire.py (S3's old/new-schema wire
...
image:
    ...
    docker/run.sh pytest tests/test_message_versioning_parse_boundary.py
"""
import hashlib
import os
import shutil
...
def test_newer_schemas_extra_field_ignored_by_older_reader(tmp_path):
    ...
    # already covered by tests/test_fieldmap*.py and test_message_versioning_wire.py).
    inc.write_text("message pong {\nint a;\nint b;\n};\n", encoding="utf-8")
