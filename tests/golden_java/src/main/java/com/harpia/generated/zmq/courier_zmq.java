...
// push/pull: newSender()/newReceiver().
...
// factory that knows courier's SocketType/bind-vs-connect/origin-id
...
public final class courier_zmq {
    private courier_zmq() {}
    ...
    public static HarpiaZmq.Sender newSender(ZContext ctx, String endpoint) {
        return new HarpiaZmq.Sender(ctx, SocketType.PUSH, endpoint, false,
            HarpiaZmq.runtimeOriginId(), courier.getDefaultInstance());
    }
    ...
    public static HarpiaZmq.Sender newSender(ZContext ctx, String endpoint,
        ...
        return new HarpiaZmq.Sender(ctx, SocketType.PUSH, endpoint, false,
            HarpiaZmq.runtimeOriginId(), courier.getDefaultInstance(), curve);
    }
