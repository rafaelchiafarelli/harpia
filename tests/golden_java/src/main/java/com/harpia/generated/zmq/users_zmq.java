...
// factory that knows users's SocketType/bind-vs-connect/origin-id
...
public final class users_zmq {
    ...
    public static HarpiaZmq.Sender newSender(ZContext ctx, String endpoint) {
        return new HarpiaZmq.Sender(ctx, SocketType.PUSH, endpoint, false,
            ORIGIN_ID, users.getDefaultInstance());
    }
    ...
    public static HarpiaZmq.Sender newSender(ZContext ctx, String endpoint,
        ...
        return new HarpiaZmq.Sender(ctx, SocketType.PUSH, endpoint, false,
            ORIGIN_ID, users.getDefaultInstance(), curve);
    }
