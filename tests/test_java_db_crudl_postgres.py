...
Opt-in, same posture as tests/test_stage8_pg.py (the C++ target's own live-
...
test_stage8_pg.py's own docstring:
    ...
    HARPIA_PG_DSN="host=harpia-pg dbname=harpiadb user=harpia password=harpiapass" \\
        pytest tests/test_java_db_crudl_postgres.py
"""
import os
import shutil
import subprocess
...
from tests._java_gradle_helpers import generate, build_and_classpath  # noqa: E402
from tests.test_java_db_crudl import _USERS_CRUDL_HELPER  # noqa: E402
