...
#ifndef HARPIA_SOAP_USERS_6cea4c29647b10eb99b42c762ac09f75
#define HARPIA_SOAP_USERS_6cea4c29647b10eb99b42c762ac09f75
...
#include "xml/users_6cea4c29647b10eb99b42c762ac09f75_xml.h"   // brings tinyxml2 + the XML runtime
...
//   <soap:Header><credentials><user>users</user><pswd>6cea4c29647b10eb99b42c762ac09f75</pswd></credentials></soap:Header>
...
inline bool authorized_users(const ::tinyxml2::XMLDocument& doc) {
    ...
    return ::harpia::soap::detail::child_text(cred, "user") == "users" &&
           ::harpia::soap::detail::child_text(cred, "pswd") == "6cea4c29647b10eb99b42c762ac09f75";
}
...
#endif  // HARPIA_SOAP_USERS_6cea4c29647b10eb99b42c762ac09f75
