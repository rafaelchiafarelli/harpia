...
#ifndef HARPIA_SOAP_USERS_738be851643f8e1a41c121caf519d41f
#define HARPIA_SOAP_USERS_738be851643f8e1a41c121caf519d41f
...
#include "xml/users_738be851643f8e1a41c121caf519d41f_xml.h"   // brings tinyxml2 + the XML runtime

// Minimal SOAP-over-HTTP access for users, backed by the CRUDL DAO. Register on
// an httplib::Server with a base path; POST a SOAP envelope to <base>/users:
...
//   <soap:Header><credentials><user>users</user><pswd>738be851643f8e1a41c121caf519d41f</pswd></credentials></soap:Header>
...
inline bool authorized_users(const ::tinyxml2::XMLDocument& doc) {
    ...
    return ::harpia::soap::detail::child_text(cred, "user") == "users" &&
           ::harpia::soap::detail::child_text(cred, "pswd") == "738be851643f8e1a41c121caf519d41f";
}
...
inline void register_users_soap(::httplib::Server& svr, ::sqlite3* db,
    ...
    svr.Post(base + "/users",
        ...
        if (!authorized_users(doc)) {
            res.status = 401;
            res.set_content(envelope_users(
...
#endif  // HARPIA_SOAP_USERS_738be851643f8e1a41c121caf519d41f
