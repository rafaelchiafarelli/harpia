...
#ifndef HARPIA_SOAP_CREW_c96f8fd7f45108efee5a8ecb43eab1da
#define HARPIA_SOAP_CREW_c96f8fd7f45108efee5a8ecb43eab1da
...
#include "xml/crew_c96f8fd7f45108efee5a8ecb43eab1da_xml.h"   // brings tinyxml2 + the XML runtime

// Minimal SOAP-over-HTTP access for crew, backed by the CRUDL DAO. Register on
// a crow::SimpleApp with a base path; POST a SOAP envelope to <base>/crew:
...
inline std::string envelope_crew(const std::string& body) {
    return "<?xml version=\"1.0\"?>"
           "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
           "<soap:Body>" + body + "</soap:Body></soap:Envelope>";
}

// True iff the envelope carries the correct credential for crew. The handler
// gates every operation on this; exposed so it can be unit-tested directly.
inline bool authorized_crew(const ::tinyxml2::XMLDocument& doc) {
...
inline void register_crew_soap(crow::SimpleApp& app, ::soci::session& db,
    ...
    app.route_dynamic(base + "/crew").methods(crow::HTTPMethod::POST)(
        ...
        if (name == "get") {
            ...
            const auto* m = op->FirstChildElement();          // the crew element
            ::crew msg;
...
#endif  // HARPIA_SOAP_CREW_c96f8fd7f45108efee5a8ecb43eab1da
