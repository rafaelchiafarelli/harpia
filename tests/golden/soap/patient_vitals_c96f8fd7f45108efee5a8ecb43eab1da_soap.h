...
#ifndef HARPIA_SOAP_PATIENT_VITALS_c96f8fd7f45108efee5a8ecb43eab1da
#define HARPIA_SOAP_PATIENT_VITALS_c96f8fd7f45108efee5a8ecb43eab1da
...
#include "xml/patient_vitals_c96f8fd7f45108efee5a8ecb43eab1da_xml.h"   // brings tinyxml2 + the XML runtime

// Minimal SOAP-over-HTTP access for patient_vitals, backed by the CRUDL DAO. Register on
// a crow::SimpleApp with a base path; POST a SOAP envelope to <base>/patient_vitals:
...
inline std::string envelope_patient_vitals(const std::string& body) {
    return "<?xml version=\"1.0\"?>"
           "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
           "<soap:Body>" + body + "</soap:Body></soap:Envelope>";
}

// True iff the envelope carries the correct credential for patient_vitals. The handler
// gates every operation on this; exposed so it can be unit-tested directly.
inline bool authorized_patient_vitals(const ::tinyxml2::XMLDocument& doc) {
    ...
    return ::harpia::soap::detail::child_text(cred, "user") == "patient_vitals" &&
           ::harpia::soap::detail::child_text(cred, "pswd") == "c96f8fd7f45108efee5a8ecb43eab1da";
}

inline bool authorized_patient_vitals(const std::string& soap_xml) {
    ::tinyxml2::XMLDocument doc;
    if (doc.Parse(soap_xml.c_str()) != ::tinyxml2::XML_SUCCESS) return false;
    return authorized_patient_vitals(doc);
}

inline void register_patient_vitals_soap(crow::SimpleApp& app, ::soci::session& db,
    ...
    ::soci::session* dbp = &db;
    app.route_dynamic(base + "/patient_vitals").methods(crow::HTTPMethod::POST)(
        ...
        if (!authorized_patient_vitals(doc)) {
            res.code = 401;
            reply(envelope_patient_vitals(
        ...
        if (name == "get") {
            ...
            const auto* m = op->FirstChildElement();          // the patient_vitals element
            ::patient_vitals msg;
...
#endif  // HARPIA_SOAP_PATIENT_VITALS_c96f8fd7f45108efee5a8ecb43eab1da
