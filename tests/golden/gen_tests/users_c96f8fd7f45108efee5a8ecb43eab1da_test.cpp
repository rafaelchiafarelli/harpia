...
int rest_api() {
    ...
    const ::httplib::Headers cred = {{"X-User", "users"}, {"X-Pswd", "c96f8fd7f45108efee5a8ecb43eab1da"}};
    const ::httplib::Headers credx = {{"X-User", "users"}, {"X-Pswd", "c96f8fd7f45108efee5a8ecb43eab1da"}, {"Accept", "application/xml"}};
    int code = 0;
    do {
