...
#include "soap/users_c96f8fd7f45108efee5a8ecb43eab1da_soap.h"
...
int access_rights() {
    const std::string good = "<soap:Envelope><soap:Header><credentials><user>users</user><pswd>c96f8fd7f45108efee5a8ecb43eab1da</pswd></credentials></soap:Header><soap:Body/></soap:Envelope>";
...
int rest_api() {
    ...
    const harpia_test::Headers cred = {{"X-User", "users"}, {"X-Pswd", "c96f8fd7f45108efee5a8ecb43eab1da"}};
    const harpia_test::Headers credx = {{"X-User", "users"}, {"X-Pswd", "c96f8fd7f45108efee5a8ecb43eab1da"}, {"Accept", "application/xml"}};
    int code = 0;
    do {
        ...
        auto bad = cli.Get("/api/v1/users", harpia_test::Headers{{"X-User", "users"}, {"X-Pswd", "nope"}});
        ...
        auto post = cli.Post("/api/v1/users", body, "application/json", cred);
        ...
        auto xpost = cli.Post("/api/v1/users", axml, "application/xml", cred);
        ...
        auto put = cli.Put("/api/v1/users/1", bb, "application/json", cred);
