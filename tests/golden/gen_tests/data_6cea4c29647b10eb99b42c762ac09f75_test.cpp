...
#include "soap/data_6cea4c29647b10eb99b42c762ac09f75_soap.h"
#include "json/data_6cea4c29647b10eb99b42c762ac09f75_json.h"
#include "xml/data_6cea4c29647b10eb99b42c762ac09f75_xml.h"
#include "rest/data_6cea4c29647b10eb99b42c762ac09f75_rest.h"
...
int simple_access() {
    ...
    if (m.status_6cea4c29647b10eb99b42c762ac09f75() != "status_6cea4c29647b10eb99b42c762ac09f75_a") return 14;
    if (m.error_6cea4c29647b10eb99b42c762ac09f75() != "error_6cea4c29647b10eb99b42c762ac09f75_a") return 15;
    if (m.originator_6cea4c29647b10eb99b42c762ac09f75() != "originator_6cea4c29647b10eb99b42c762ac09f75_a") return 16;
    return 0;
}
...
int database_roundtrip() {
    ...
    ::data upd = a;
    upd.set_status_6cea4c29647b10eb99b42c762ac09f75("status_6cea4c29647b10eb99b42c762ac09f75_u");
    if (!dao.update(upd)) return 25;
    ::data got2;
    if (!dao.read(1, &got2)) return 26;
    if (got2.status_6cea4c29647b10eb99b42c762ac09f75() != "status_6cea4c29647b10eb99b42c762ac09f75_u") return 27;
...
int access_rights() {
    const std::string good = "<soap:Envelope><soap:Header><credentials><user>data</user><pswd>6cea4c29647b10eb99b42c762ac09f75</pswd></credentials></soap:Header><soap:Body/></soap:Envelope>";
...
int rest_api() {
    ...
    const ::httplib::Headers credx = {{"X-User", "data"}, {"X-Pswd", "6cea4c29647b10eb99b42c762ac09f75"}, {"Accept", "application/xml"}};
    int code = 0;
    do {
        ...
        if (gx->body.find("status_6cea4c29647b10eb99b42c762ac09f75_a") == std::string::npos) { code = 96; break; }
        ::data ax = a;
        ...
        if (gx2->body.find("status_6cea4c29647b10eb99b42c762ac09f75_a") == std::string::npos) { code = 99; break; }
        ::data b = a;
...
int soap_api() {
    ...
    svr.wait_until_ready();
    ::httplib::Client cli("127.0.0.1", port);
    const std::string hdr = "<soap:Header><credentials><user>data</user><pswd>6cea4c29647b10eb99b42c762ac09f75</pswd></credentials></soap:Header>";
