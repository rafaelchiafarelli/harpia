...
#include "soap/data_738be851643f8e1a41c121caf519d41f_soap.h"
#include "json/data_738be851643f8e1a41c121caf519d41f_json.h"
#include "xml/data_738be851643f8e1a41c121caf519d41f_xml.h"
#include "rest/data_738be851643f8e1a41c121caf519d41f_rest.h"
...
int simple_access() {
    ...
    if (m.status_738be851643f8e1a41c121caf519d41f() != "status_738be851643f8e1a41c121caf519d41f_a") return 14;
    if (m.error_738be851643f8e1a41c121caf519d41f() != "error_738be851643f8e1a41c121caf519d41f_a") return 15;
    if (m.originator_738be851643f8e1a41c121caf519d41f() != "originator_738be851643f8e1a41c121caf519d41f_a") return 16;
    return 0;
}
...
int database_roundtrip() {
    ...
    ::data upd = a;
    upd.set_status_738be851643f8e1a41c121caf519d41f("status_738be851643f8e1a41c121caf519d41f_u");
    if (!dao.update(upd)) return 25;
    ::data got2;
    if (!dao.read(1, &got2)) return 26;
    if (got2.status_738be851643f8e1a41c121caf519d41f() != "status_738be851643f8e1a41c121caf519d41f_u") return 27;
...
int access_rights() {
    const std::string good = "<soap:Envelope><soap:Header><credentials><user>data</user><pswd>738be851643f8e1a41c121caf519d41f</pswd></credentials></soap:Header><soap:Body/></soap:Envelope>";
...
int rest_api() {
    ...
    const ::httplib::Headers cred = {{"X-User", "data"}, {"X-Pswd", "738be851643f8e1a41c121caf519d41f"}};
    const ::httplib::Headers credx = {{"X-User", "data"}, {"X-Pswd", "738be851643f8e1a41c121caf519d41f"}, {"Accept", "application/xml"}};
    int code = 0;
    do {
        ...
        if (got->body.find("status_738be851643f8e1a41c121caf519d41f_a") == std::string::npos) { code = 86; break; }
        ...
        if (gx->body.find("status_738be851643f8e1a41c121caf519d41f_a") == std::string::npos) { code = 96; break; }
        ::data ax = a;
        ...
        if (gx2->body.find("status_738be851643f8e1a41c121caf519d41f_a") == std::string::npos) { code = 99; break; }
        ::data b = a;
        b.set_status_738be851643f8e1a41c121caf519d41f("status_738be851643f8e1a41c121caf519d41f_u");
        std::string bb;
        ...
        if (!g2 || g2->body.find("status_738be851643f8e1a41c121caf519d41f_u") == std::string::npos) { code = 90; break; }
...
int soap_api() {
    ...
    svr.wait_until_ready();
    ::httplib::Client cli("127.0.0.1", port);
    const std::string hdr = "<soap:Header><credentials><user>data</user><pswd>738be851643f8e1a41c121caf519d41f</pswd></credentials></soap:Header>";
    ...
    do {
        ...
        if (g->body.find("status_738be851643f8e1a41c121caf519d41f_a") == std::string::npos) { code = 106; break; }
        ::data b = a;
        b.set_status_738be851643f8e1a41c121caf519d41f("status_738be851643f8e1a41c121caf519d41f_u");
        ...
        if (!g2 || g2->body.find("status_738be851643f8e1a41c121caf519d41f_u") == std::string::npos) { code = 108; break; }
