...
#include "rest/vip_users_734126ee6efdfbd64a1678bf49ee9683_rest.h"
...
int soap_api() {
    ...
    svr.wait_until_ready();
    ::httplib::Client cli("127.0.0.1", port);
    const std::string hdr = "<soap:Header><credentials><user>vip_users</user><pswd>734126ee6efdfbd64a1678bf49ee9683</pswd></credentials></soap:Header>";
