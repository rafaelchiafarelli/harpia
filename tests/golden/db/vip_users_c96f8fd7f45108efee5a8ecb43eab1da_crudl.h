...
public:
    ...
    bool list(std::vector<::vip_users>* out, long long offset, long long limit) {
        try {
            ...
            std::string l4; ::soci::indicator n4;
            std::string l5; ::soci::indicator n5;
            ::soci::statement st = (db_.prepare << "SELECT \"ID_c96f8fd7f45108efee5a8ecb43eab1da\", \"name\", \"family\", \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\", \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\", \"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\" FROM \"table_vip_users\" LIMIT :lim OFFSET :off", ::soci::use(limit), ::soci::use(offset),
                ::soci::into(l0, n0), ::soci::into(l1, n1), ::soci::into(l2, n2), ::soci::into(l3, n3), ::soci::into(l4, n4), ::soci::into(l5, n5));
            st.execute();
            while (st.fetch()) {
                ::vip_users row;
