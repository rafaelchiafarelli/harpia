...
#ifndef HARPIA_CRUDL_DATA_6cea4c29647b10eb99b42c762ac09f75
#define HARPIA_CRUDL_DATA_6cea4c29647b10eb99b42c762ac09f75
...
public:
    ...
    bool create_table() { return exec("CREATE TABLE IF NOT EXISTS \"table_data\" (\"ID_6cea4c29647b10eb99b42c762ac09f75\" INTEGER PRIMARY KEY, \"i\" INTEGER, \"j\" INTEGER, \"val_vari\" INTEGER, \"val_var\" INTEGER, \"val_val\" INTEGER, \"car\" INTEGER, \"STATUS_6cea4c29647b10eb99b42c762ac09f75\" TEXT, \"ERROR_6cea4c29647b10eb99b42c762ac09f75\" TEXT, \"ORIGINATOR_6cea4c29647b10eb99b42c762ac09f75\" TEXT);") && exec("CREATE TABLE IF NOT EXISTS \"table_data__val_a\" (\"owner\" INTEGER, \"key\" TEXT, \"value\" TEXT, PRIMARY KEY(\"owner\", \"key\"));") && exec("CREATE TABLE IF NOT EXISTS \"table_data__val_b\" (\"owner\" INTEGER, \"key\" TEXT, \"value\" INTEGER, PRIMARY KEY(\"owner\", \"key\"));") && exec("CREATE TABLE IF NOT EXISTS \"table_data__val_c\" (\"owner\" INTEGER, \"key\" INTEGER, \"value\" TEXT, PRIMARY KEY(\"owner\", \"key\"));") && exec("CREATE TABLE IF NOT EXISTS \"table_data__tags\" (\"owner\" INTEGER, \"ordinal\" INTEGER, \"value\" INTEGER, PRIMARY KEY(\"owner\", \"ordinal\"));"); }
    bool drop_table()   { return exec("DROP TABLE IF EXISTS \"table_data__val_a\";") && exec("DROP TABLE IF EXISTS \"table_data__val_b\";") && exec("DROP TABLE IF EXISTS \"table_data__val_c\";") && exec("DROP TABLE IF EXISTS \"table_data__tags\";") && exec("DROP TABLE IF EXISTS \"table_data\";"); }

    bool create(const ::data& msg) {
        ::sqlite3_stmt* st = nullptr;
        if (::sqlite3_prepare_v2(db_,
                "INSERT INTO \"table_data\" (\"ID_6cea4c29647b10eb99b42c762ac09f75\", \"i\", \"j\", \"val_vari\", \"val_var\", \"val_val\", \"car\", \"STATUS_6cea4c29647b10eb99b42c762ac09f75\", \"ERROR_6cea4c29647b10eb99b42c762ac09f75\", \"ORIGINATOR_6cea4c29647b10eb99b42c762ac09f75\") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
                -1, &st, nullptr) != SQLITE_OK) return false;
        ::sqlite3_bind_int(st, 1, msg.id_6cea4c29647b10eb99b42c762ac09f75());
        ...
        ::sqlite3_bind_text(st, 8, msg.status_6cea4c29647b10eb99b42c762ac09f75().c_str(), -1, SQLITE_TRANSIENT);
        ::sqlite3_bind_text(st, 9, msg.error_6cea4c29647b10eb99b42c762ac09f75().c_str(), -1, SQLITE_TRANSIENT);
        ::sqlite3_bind_text(st, 10, msg.originator_6cea4c29647b10eb99b42c762ac09f75().c_str(), -1, SQLITE_TRANSIENT);
        ...
        for (const auto& kv : msg.val().a()) {
            ...
            ::sqlite3_bind_int(cs, 1, msg.id_6cea4c29647b10eb99b42c762ac09f75());
    ...
    bool read(std::int64_t id, ::data* msg) {
        ::sqlite3_stmt* st = nullptr;
        if (::sqlite3_prepare_v2(db_,
                "SELECT \"ID_6cea4c29647b10eb99b42c762ac09f75\", \"i\", \"j\", \"val_vari\", \"val_var\", \"val_val\", \"car\", \"STATUS_6cea4c29647b10eb99b42c762ac09f75\", \"ERROR_6cea4c29647b10eb99b42c762ac09f75\", \"ORIGINATOR_6cea4c29647b10eb99b42c762ac09f75\" FROM \"table_data\" WHERE \"ID_6cea4c29647b10eb99b42c762ac09f75\" = ?;",
                -1, &st, nullptr) != SQLITE_OK) return false;
    ...
    bool update(const ::data& msg) {
        ::sqlite3_stmt* st = nullptr;
        if (::sqlite3_prepare_v2(db_,
                "UPDATE \"table_data\" SET \"i\" = ?, \"j\" = ?, \"val_vari\" = ?, \"val_var\" = ?, \"val_val\" = ?, \"car\" = ?, \"STATUS_6cea4c29647b10eb99b42c762ac09f75\" = ?, \"ERROR_6cea4c29647b10eb99b42c762ac09f75\" = ?, \"ORIGINATOR_6cea4c29647b10eb99b42c762ac09f75\" = ? WHERE \"ID_6cea4c29647b10eb99b42c762ac09f75\" = ?;",
                -1, &st, nullptr) != SQLITE_OK) return false;
        ...
        ::sqlite3_bind_text(st, 7, msg.status_6cea4c29647b10eb99b42c762ac09f75().c_str(), -1, SQLITE_TRANSIENT);
        ::sqlite3_bind_text(st, 8, msg.error_6cea4c29647b10eb99b42c762ac09f75().c_str(), -1, SQLITE_TRANSIENT);
        ::sqlite3_bind_text(st, 9, msg.originator_6cea4c29647b10eb99b42c762ac09f75().c_str(), -1, SQLITE_TRANSIENT);
        ::sqlite3_bind_int64(st, 10, msg.id_6cea4c29647b10eb99b42c762ac09f75());
        const bool ok = ::sqlite3_step(st) == SQLITE_DONE;
        ::sqlite3_finalize(st);
        if (!ok) return false;
        {
            ...
            if (::sqlite3_prepare_v2(db_, "DELETE FROM \"table_data__val_a\" WHERE \"owner\" = ?;", -1, &ds, nullptr) == SQLITE_OK) {
                ::sqlite3_bind_int(ds, 1, msg.id_6cea4c29647b10eb99b42c762ac09f75());
                ::sqlite3_step(ds);
                ::sqlite3_finalize(ds);
            }
        }
    ...
    bool remove(std::int64_t id) {
        ::sqlite3_stmt* st = nullptr;
        if (::sqlite3_prepare_v2(db_,
                "DELETE FROM \"table_data\" WHERE \"ID_6cea4c29647b10eb99b42c762ac09f75\" = ?;",
                -1, &st, nullptr) != SQLITE_OK) return false;
        ::sqlite3_bind_int64(st, 1, id);
        const bool ok = ::sqlite3_step(st) == SQLITE_DONE;
        ::sqlite3_finalize(st);
    ...
    bool list(std::vector<::data>* out) {
        ::sqlite3_stmt* st = nullptr;
        if (::sqlite3_prepare_v2(db_,
                "SELECT \"ID_6cea4c29647b10eb99b42c762ac09f75\", \"i\", \"j\", \"val_vari\", \"val_var\", \"val_val\", \"car\", \"STATUS_6cea4c29647b10eb99b42c762ac09f75\", \"ERROR_6cea4c29647b10eb99b42c762ac09f75\", \"ORIGINATOR_6cea4c29647b10eb99b42c762ac09f75\" FROM \"table_data\";",
                -1, &st, nullptr) != SQLITE_OK) return false;
...
private:
    ...
    void extract(::sqlite3_stmt* st, ::data* msg) {
        msg->set_id_6cea4c29647b10eb99b42c762ac09f75(::sqlite3_column_int(st, 0));
        ...
        { const unsigned char* p = ::sqlite3_column_text(st, 7); msg->set_status_6cea4c29647b10eb99b42c762ac09f75(p ? reinterpret_cast<const char*>(p) : ""); }
        { const unsigned char* p = ::sqlite3_column_text(st, 8); msg->set_error_6cea4c29647b10eb99b42c762ac09f75(p ? reinterpret_cast<const char*>(p) : ""); }
        { const unsigned char* p = ::sqlite3_column_text(st, 9); msg->set_originator_6cea4c29647b10eb99b42c762ac09f75(p ? reinterpret_cast<const char*>(p) : ""); }
        {
            ::sqlite3_stmt* cs = nullptr;
...
#endif  // HARPIA_CRUDL_DATA_6cea4c29647b10eb99b42c762ac09f75
