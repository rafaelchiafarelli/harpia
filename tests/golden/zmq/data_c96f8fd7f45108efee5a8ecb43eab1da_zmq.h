...
// with no client certs). Guarded separately from the per-message HARPIA_ZMQ_DATA_c96f8fd7f45108efee5a8ecb43eab1da so
...
public:
    ...
    static const std::string& origin_id() {
        static const std::string id = "332531426817885853";
        return id;
    }
...
#endif  // HARPIA_ZMQ_DATA_c96f8fd7f45108efee5a8ecb43eab1da
