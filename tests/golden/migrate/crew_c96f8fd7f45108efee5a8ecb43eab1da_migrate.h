...
inline bool migrate_crew(::soci::session& db,
    ...
    try {
        ...
        if (!have.count("STATUS_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"crew_table\" ADD COLUMN \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        if (!have.count("ERROR_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"crew_table\" ADD COLUMN \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_c96f8fd7f45108efee5a8ecb43eab1da", "name", "STATUS_c96f8fd7f45108efee5a8ecb43eab1da", "ERROR_c96f8fd7f45108efee5a8ecb43eab1da", "ORIGINATOR" };
...
inline const char* version_crew() { return "c96f8fd7f45108efee5a8ecb43eab1da"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_CREW_c96f8fd7f45108efee5a8ecb43eab1da
