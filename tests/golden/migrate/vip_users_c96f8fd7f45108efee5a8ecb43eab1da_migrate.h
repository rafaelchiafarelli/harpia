...
inline bool migrate_vip_users(::soci::session& db,
    ...
    try {
        ...
        if (!have.count("STATUS_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        if (!have.count("ERROR_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        if (!have.count("ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"table_vip_users\" ADD COLUMN \"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_c96f8fd7f45108efee5a8ecb43eab1da", "name", "family", "STATUS_c96f8fd7f45108efee5a8ecb43eab1da", "ERROR_c96f8fd7f45108efee5a8ecb43eab1da", "ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da" };
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"table_vip_users__retype_tmp\" (\"ID_c96f8fd7f45108efee5a8ecb43eab1da\" INTEGER PRIMARY KEY, \"name\" TEXT, \"family\" TEXT, \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT, \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT, \"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT);";
            db << "INSERT INTO \"table_vip_users__retype_tmp\" (\"ID_c96f8fd7f45108efee5a8ecb43eab1da\", \"name\", \"family\", \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\", \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\", \"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\") SELECT CAST(\"ID_c96f8fd7f45108efee5a8ecb43eab1da\" AS INTEGER), CAST(\"name\" AS TEXT), CAST(\"family\" AS TEXT), CAST(\"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT), CAST(\"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT), CAST(\"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT) FROM \"table_vip_users\";";
            db << "DROP TABLE \"table_vip_users\";";
            db << "ALTER TABLE \"table_vip_users__retype_tmp\" RENAME TO \"table_vip_users\";";
        }
        }
        // stamp the current version
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('table_vip_users', 'c96f8fd7f45108efee5a8ecb43eab1da');";
        return true;
