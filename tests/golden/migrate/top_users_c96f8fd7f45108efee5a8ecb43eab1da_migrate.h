...
inline bool migrate_top_users(::soci::session& db,
    ...
    try {
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"user_table__retype_tmp\" (\"ID_c96f8fd7f45108efee5a8ecb43eab1da\" INTEGER PRIMARY KEY, \"sponsor\" TEXT, \"name\" TEXT NOT NULL, \"myUsers\" INTEGER, \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT, \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT, \"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT);";
            db << "INSERT INTO \"user_table__retype_tmp\" (\"ID_c96f8fd7f45108efee5a8ecb43eab1da\", \"sponsor\", \"name\", \"myUsers\", \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\", \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\", \"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\") SELECT CAST(\"ID_c96f8fd7f45108efee5a8ecb43eab1da\" AS INTEGER), CAST(\"sponsor\" AS TEXT), CAST(\"name\" AS TEXT), CAST(\"myUsers\" AS INTEGER), CAST(\"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT), CAST(\"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT), CAST(\"ORIGINATOR_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT) FROM \"user_table\";";
