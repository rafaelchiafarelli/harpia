...
#ifndef HARPIA_MIGRATE_PATIENT_VITALS_c96f8fd7f45108efee5a8ecb43eab1da
#define HARPIA_MIGRATE_PATIENT_VITALS_c96f8fd7f45108efee5a8ecb43eab1da
...
// Schema migration for patient_vitals (spec 8 / 7.2 "validation/transformative functions
...
// idempotent (e.g. guard with a WHERE clause) since migrate_patient_vitals may run
// on every startup.
//
...
inline bool migrate_patient_vitals(::soci::session& db,
    ...
    try {
        ...
        std::set<std::string> have;
        {
            ...
            ::soci::statement _cs = (db.prepare << "SELECT \"name\" FROM pragma_table_info('patient_vitals_table');",
                                     ::soci::into(_cn, _ci));
            _cs.execute();
        ...
        // (a second migrate_patient_vitals call, or a table that never had it).
        ...
        if (!have.count("STATUS_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"patient_vitals_table\" ADD COLUMN \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        if (!have.count("ERROR_c96f8fd7f45108efee5a8ecb43eab1da")) {
            db << "ALTER TABLE \"patient_vitals_table\" ADD COLUMN \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT;";
        }
        if (!have.count("ORIGINATOR")) {
            db << "ALTER TABLE \"patient_vitals_table\" ADD COLUMN \"ORIGINATOR\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_c96f8fd7f45108efee5a8ecb43eab1da", "patient_id", "heart_rate", "device_note", "STATUS_c96f8fd7f45108efee5a8ecb43eab1da", "ERROR_c96f8fd7f45108efee5a8ecb43eab1da", "ORIGINATOR" };
            for (auto _hit = have.begin(); _hit != have.end(); ) {
                if (!_current.count(*_hit)) {
                    const std::string& _dc = *_hit;
                    db << "ALTER TABLE \"patient_vitals_table\" DROP COLUMN \"" + _dc + "\";";
        ...
        std::map<std::string, std::string> have_types;
        {
            ...
            ::soci::statement _ts = (db.prepare << "SELECT \"name\", \"type\" FROM pragma_table_info('patient_vitals_table');",
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"patient_vitals_table__retype_tmp\" (\"ID_c96f8fd7f45108efee5a8ecb43eab1da\" INTEGER PRIMARY KEY, \"patient_id\" TEXT, \"heart_rate\" REAL NOT NULL, \"device_note\" TEXT, \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT, \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" TEXT, \"ORIGINATOR\" TEXT);";
            db << "INSERT INTO \"patient_vitals_table__retype_tmp\" (\"ID_c96f8fd7f45108efee5a8ecb43eab1da\", \"patient_id\", \"heart_rate\", \"device_note\", \"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\", \"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\", \"ORIGINATOR\") SELECT CAST(\"ID_c96f8fd7f45108efee5a8ecb43eab1da\" AS INTEGER), CAST(\"patient_id\" AS TEXT), CAST(\"heart_rate\" AS REAL), CAST(\"device_note\" AS TEXT), CAST(\"STATUS_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT), CAST(\"ERROR_c96f8fd7f45108efee5a8ecb43eab1da\" AS TEXT), CAST(\"ORIGINATOR\" AS TEXT) FROM \"patient_vitals_table\";";
            db << "DROP TABLE \"patient_vitals_table\";";
            db << "ALTER TABLE \"patient_vitals_table__retype_tmp\" RENAME TO \"patient_vitals_table\";";
        }
        }
        // stamp the current version
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('patient_vitals_table', 'c96f8fd7f45108efee5a8ecb43eab1da');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_patient_vitals() { return "c96f8fd7f45108efee5a8ecb43eab1da"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_PATIENT_VITALS_c96f8fd7f45108efee5a8ecb43eab1da
