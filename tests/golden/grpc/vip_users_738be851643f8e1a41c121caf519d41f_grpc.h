...
#ifndef HARPIA_GRPC_VIP_USERS_738be851643f8e1a41c121caf519d41f
#define HARPIA_GRPC_VIP_USERS_738be851643f8e1a41c121caf519d41f
...
#include "sqlite3.h"
#include "protofiles/vip_users_738be851643f8e1a41c121caf519d41f_service.grpc.pb.h"
...
// call must carry x-user: vip_users and x-pswd: 738be851643f8e1a41c121caf519d41f metadata, or it is rejected
...
public:
    explicit vip_users_service(::sqlite3* db) : db_(db) {}
    ...
    static bool authorized(::grpc::ServerContext* ctx) {
        ...
        return u != md.end() && p != md.end() &&
               ...
               ::std::string(p->second.data(), p->second.length()) == "738be851643f8e1a41c121caf519d41f";
    }
...
#endif  // HARPIA_GRPC_VIP_USERS_738be851643f8e1a41c121caf519d41f
