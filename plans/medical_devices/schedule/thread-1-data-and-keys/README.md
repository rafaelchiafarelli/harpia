...
since deleted from `plans/`, see `Capability/CLAUDE.md` for what it left
...
- [track-o-key-management.md](track-o-key-management.md) — pluggable
  `KeyProvider`, envelope encryption, rotation, crypto-shredding.
- [track-h-schema-evolution.md](track-h-schema-evolution.md) — child-table
  (map/repeated/repeated-composed) DB schema migration support.
- [track-a-db-encryption.md](track-a-db-encryption.md) — DB field-level
  encryption for `phi` columns + audit-on-access wiring.
- [track-k-db-segregation.md](track-k-db-segregation.md) — public/private
...
- **Ground Rule 6 (`../foundation.md`, added 2026-08-23):** any session
  ...
  deferred. Add a row to `plans/doxygen-generation.md` §4 if the work
