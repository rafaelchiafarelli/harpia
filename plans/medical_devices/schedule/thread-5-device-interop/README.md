...
- [track-p-dds-transport.md](track-p-dds-transport.md) — DDS transport
  adapter (ASTM F2761/OpenICE-class bedside device bus).
- [track-q-sdc-biceps.md](track-q-sdc-biceps.md) — IEEE 11073 SDC/BICEPS
  device-interop bindings (scoping + WS-Discovery responder only).
- [track-r-fhir-facade.md](track-r-fhir-facade.md) — HL7 FHIR façade
...
- Don't let Track Q's scoping work quietly turn into implementation
  ...
  both tracks, pull from the backlog (`plans/README.md`) rather than
  scope-creep Track Q.
